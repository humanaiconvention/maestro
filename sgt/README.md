...
> For subsystem navigation and current HAIC-facing status, start with [README-new.md](/D:/humanai-convention/sgt/README-new.md), [STATUS.md](/D:/humanai-convention/sgt/STATUS.md), and [HANDOFF.md](/D:/humanai-convention/sgt/HANDOFF.md).
